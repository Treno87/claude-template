...
class MessageGenerator:
    ...
    def get_personalized_completion(self, summary=None):
        ...
        # If no work was done (base_message is None), use a default completion message
        if not base_message:
        ...
        if current_personality == "butler":
            if user_nickname:
                return f"{base_message}. Is there anything else I can assist you with, {user_nickname}?"
            return f"{base_message}. Is there anything else I can assist you with?"
        elif current_personality == "casual":
            if user_nickname:
